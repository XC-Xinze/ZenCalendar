...
class ZenMenu:
        ...
        def add_task(self):
                ...
                CalTask(title,description,custom_date, uid=None)
                self.manager.save()
        ...
        def add_event(self):
                ...
                CalEvent(title,description,custom_date, start_time,end_time,uid = None)
                self.manager.save()
        ...
        def delete_item(self):
                ...
                try:
                        ...
                        if isinstance(target, CalEvent):
                                        self.manager.delete_id_item(CalEvent.CalEvent_list, target.id)
                        else:
                                        self.manager.delete_id_item(CalTask.CalTask_list, target.id)
                except IndexError:
                        print("Wrong Index.")
                except ValueError:
